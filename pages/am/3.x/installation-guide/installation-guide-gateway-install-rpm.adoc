...
:page-permalink: am/current/am_installguide_gateway_install_rpm.html
...
NOTE: RPM install is not supported on distributions with old versions of RPM, such as SLES 11 and CentOS 5. Please see link:/am/current/am_installguide_gateway_install_zip.html[Install Gravitee.io Access Gateway with .zip] instead.
